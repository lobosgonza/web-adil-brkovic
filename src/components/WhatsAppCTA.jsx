...
export const WhatsAppCTA = () => {
	...
	return (
		<a
			...
			{/* BOTÓN: Pegado al borde derecho, solo redondeado a la izquierda */}
			<div className='bg-[#2e7d32] text-white p-4 rounded-l-xl shadow-[-10px_0_20px_rgba(0,0,0,0.15)] group-hover:pr-6 group-hover:pl-8 transition-all duration-300 flex items-center justify-center border-y border-l border-[#2e7d32]'>
