	...
	return (
		<footer className='section-light py-10 px-6 max-w-7xl mx-auto'>
			<div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16'>
				...
				<div className='space-y-6'>
					<Link href='/areas-de-trabajo' className='group flex items-center gap-2 border-b border-[#e67e22] pb-2 w-fit'>
					...
					<ul className='space-y-3'>
						{servicios.map((a) => (
							<li key={a.path}>
								<Link href={a.path} className='text-[11px] hover:text-[#e67e22] transition-colors font-light uppercase tracking-wider'>
									{a.name}
								</Link>
							</li>
						))}
				...
				<div className='space-y-6'>
					...
					<ul className='space-y-5'>
						...
						<li className='flex items-start gap-4'>
							...
							<div className='flex flex-col gap-1'>
								<span className='uppercase text-[9px] tracking-widest font-bold'>Ubicación</span>
								<span className='text-sm font-light'>Santiago, Chile</span>
							</div>
						</li>
					</ul>
				</div>
